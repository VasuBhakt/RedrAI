...
5. **Deterministic Reasoning**: The output reasoning strings are generated without an LLM, pulling directly from computed facts to guarantee zero hallucinations.
